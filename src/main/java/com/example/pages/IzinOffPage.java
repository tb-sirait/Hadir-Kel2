...
public class IzinOffPage {
    ...
    WebElement resultIzinOff;
    @FindBy(xpath = "//table[@aria-label='sticky table']")
    WebElement tabelIzinOff;
    ...
    public String getResultIzinOff() {
        return this.resultIzinOff.getText();
    }
    ...
    public List<String> dataIzinOff(int index){
        List<String> namaIzinOff = dataTable.getDataTableVerifikator(index, tabelIzinOff);
        return namaIzinOff;
    }
